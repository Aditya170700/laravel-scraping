                    ...
                    <tr data-id="{{ $link->id }}">
                        ...
                        <td>
                            @if ($link->item_schema_id != '' && $link->main_filter_selector != '')
                                <button type="button" class="btn btn-primary btn-scrape" title="pull the latest items">Scrape
                                    <i class="glyphicon glyphicon-repeat fast-right-spinner"
